...
namespace HyperToon
{
    public class OilPaintingEffect : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            var kuwaharaFilterMaterial =
                CoreUtils.CreateEngineMaterial("Hidden/Oil Painting/Anisotropic Kuwahara Filter");
            var lineIntegralConvolutionMaterial =
                CoreUtils.CreateEngineMaterial("Hidden/Oil Painting/Line Integral Convolution");
            ...
            depthOnlyPass = new DepthOnlyPass(RenderPassEvent.BeforeRenderingPostProcessing, RenderQueueRange.all,
                AllLayers);
        ...
        public class AnisotropicKuwaharaFilterSettings
        {
            ...
            [Space(10)] [Range(2f, 12f)] public float filterRadius = 4f;
            [Range(2f, 16f)] public float filterSharpness = 8f;
            [Range(0.125f, 8f)] public float eccentricity = 1f;
            [Space(10)] [Range(1, 4)] public int iterations = 1;
        }
        ...
        public class EdgeFlowSettings
        {
            ...
            [Space(10)] [Range(1, 64)] public int streamLineLength = 10;
        ...
        public class CompositorSettings
        {
            ...
            [Space(10)] [Range(0.25f, 1f)] public float bumpPower = 0.8f;
    ...
    public class OilPaintingEffectPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            structureTensorTex = RenderTexture.GetTemporary(blitTargetDescriptor.width, blitTargetDescriptor.height, 0,
                RenderTextureFormat.ARGBFloat);
            kuwaharaFilterTex = RenderTexture.GetTemporary(blitTargetDescriptor);
            edgeFlowTex = RenderTexture.GetTemporary(blitTargetDescriptor.width, blitTargetDescriptor.height, 0,
